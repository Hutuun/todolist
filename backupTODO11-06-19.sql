...
INSERT IGNORE INTO `sutache` (`idTache`, `nomTache`, `descriptionTache`, `idDemandeur`, `priorite`, `deadline`, `dateCreation`, `dateSuppr`, `suppr`) VALUES ('0',"upc programme","Faire un programme php",'2',0,'','2019-05-20 00:00:00','2019-05-24 00:00:00','non');
INSERT IGNORE INTO `sutache` (`idTache`, `nomTache`, `descriptionTache`, `idDemandeur`, `priorite`, `deadline`, `dateCreation`, `dateSuppr`, `suppr`) VALUES ('1',"TODO","Création d'une TODO list pour enrengistrer les tâches à faire.",'2',0,'0000-00-00 00:00:00','2019-05-23 10:00:00','0000-00-00 00:00:00','non');
...
INSERT IGNORE INTO `sutache` (`idTache`, `nomTache`, `descriptionTache`, `idDemandeur`, `priorite`, `deadline`, `dateCreation`, `dateSuppr`, `suppr`) VALUES ('4',"Visite site inv","visiter le site de l'inventaire de la recherche",'2',0,'','2019-05-24 00:00:00','2019-06-07 15:33:39','non');
INSERT IGNORE INTO `sutache` (`idTache`, `nomTache`, `descriptionTache`, `idDemandeur`, `priorite`, `deadline`, `dateCreation`, `dateSuppr`, `suppr`) VALUES ('5',"Accès intranet","Accès intranet",'2',0,'','2019-05-31 00:00:00','2019-06-07 15:33:37','non');
INSERT IGNORE INTO `sutache` (`idTache`, `nomTache`, `descriptionTache`, `idDemandeur`, `priorite`, `deadline`, `dateCreation`, `dateSuppr`, `suppr`) VALUES ('6',"Accès bd","Accès à la base de donnée",'2',0,'','2019-06-03 00:00:00','2019-06-07 15:33:33','non');
INSERT IGNORE INTO `sutache` (`idTache`, `nomTache`, `descriptionTache`, `idDemandeur`, `priorite`, `deadline`, `dateCreation`, `dateSuppr`, `suppr`) VALUES ('7',"Accès code","Accès code",'2',0,'','2019-06-03 00:00:00','2019-06-07 15:33:17','non');
...
INSERT IGNORE INTO `sutache` (`idTache`, `nomTache`, `descriptionTache`, `idDemandeur`, `priorite`, `deadline`, `dateCreation`, `dateSuppr`, `suppr`) VALUES ('9',"MCD <> phpmyadmin","Document des différence entre la vu de la base de donnée et les tables réellement dans la base de donnée",'2',0,'','2019-06-05 00:00:00','2019-06-07 15:35:40','non');
INSERT IGNORE INTO `sutache` (`idTache`, `nomTache`, `descriptionTache`, `idDemandeur`, `priorite`, `deadline`, `dateCreation`, `dateSuppr`, `suppr`) VALUES ('10',"Doc chaine de caractère en sql","Doc chaine de caractère en sql avec les fonctions utiles",'2',0,'','2019-06-05 00:00:00','2019-06-07 15:33:29','non');
INSERT IGNORE INTO `sutache` (`idTache`, `nomTache`, `descriptionTache`, `idDemandeur`, `priorite`, `deadline`, `dateCreation`, `dateSuppr`, `suppr`) VALUES ('11',"Statistiques BD","Calcul de statistiques sur la base de données de INFOFIN suite à la réunion du lundi 03/06/2019.",'2',0,'','2019-06-06 16:30:19','2019-06-11 16:15:58','non');
INSERT IGNORE INTO `sutache` (`idTache`, `nomTache`, `descriptionTache`, `idDemandeur`, `priorite`, `deadline`, `dateCreation`, `dateSuppr`, `suppr`) VALUES ('12',"Mailing PHP","Faire le mailing de INFOFIN en PHP.",'2',1,'','2019-06-06 16:30:56','0000-00-00 00:00:00','non');
INSERT IGNORE INTO `sutache` (`idTache`, `nomTache`, `descriptionTache`, `idDemandeur`, `priorite`, `deadline`, `dateCreation`, `dateSuppr`, `suppr`) VALUES ('13',"Mailing DOC/XLS","Faire le mailing de INFOFIN avec DOC et XLS.",'2',0,'','2019-06-06 16:31:27','0000-00-00 00:00:00','non');
INSERT IGNORE INTO `sutache` (`idTache`, `nomTache`, `descriptionTache`, `idDemandeur`, `priorite`, `deadline`, `dateCreation`, `dateSuppr`, `suppr`) VALUES ('14',"Présentation mailing","Modifier la présentation du mailing suite aux demandes de la réunion du lundi 03/06/2019.",'2',0,'','2019-06-06 16:32:24','0000-00-00 00:00:00','non');
INSERT IGNORE INTO `sutache` (`idTache`, `nomTache`, `descriptionTache`, `idDemandeur`, `priorite`, `deadline`, `dateCreation`, `dateSuppr`, `suppr`) VALUES ('15',"Corrections INFOFIN","Faire quelques corrections sur INFOFIN suite aux demandes lors de la réunion du lundi 03/06/2019.",'2',0,'','2019-06-06 16:33:45','0000-00-00 00:00:00','non');
INSERT IGNORE INTO `sutache` (`idTache`, `nomTache`, `descriptionTache`, `idDemandeur`, `priorite`, `deadline`, `dateCreation`, `dateSuppr`, `suppr`) VALUES ('16',"Nouveautés INFOFIN","Ajouter de nouvelles fonctionnalités sur INFOFIN suite aux demandes lors de la réunion du lundi 03/06/2019.",'2',0,'','2019-06-06 16:34:11','0000-00-00 00:00:00','non');
...
INSERT IGNORE INTO `sutache` (`idTache`, `nomTache`, `descriptionTache`, `idDemandeur`, `priorite`, `deadline`, `dateCreation`, `dateSuppr`, `suppr`) VALUES ('18',"Connection à INFOFIN","Faire en sorte de pouvoir se connecter à INFOFIN sur projetsdr.",'2',0,'','2019-06-06 16:36:30','0000-00-00 00:00:00','non');
INSERT IGNORE INTO `sutache` (`idTache`, `nomTache`, `descriptionTache`, `idDemandeur`, `priorite`, `deadline`, `dateCreation`, `dateSuppr`, `suppr`) VALUES ('19',"Seul admin subscribers","Vérifier que seuls les admins peuvent voir les subscribers sur INFOFIN et sinon le mettre en place.",'2',0,'','2019-06-06 16:37:32','0000-00-00 00:00:00','non');
INSERT IGNORE INTO `sutache` (`idTache`, `nomTache`, `descriptionTache`, `idDemandeur`, `priorite`, `deadline`, `dateCreation`, `dateSuppr`, `suppr`) VALUES ('20',"Analyse tables","Analyser les tables d'INFOFIN.",'2',0,'','2019-06-06 16:38:29','2019-06-11 16:18:44','non');
INSERT IGNORE INTO `sutache` (`idTache`, `nomTache`, `descriptionTache`, `idDemandeur`, `priorite`, `deadline`, `dateCreation`, `dateSuppr`, `suppr`) VALUES ('21',"Sécurité Mysqli et PDO","Voir les différences, notamment au niveau de la sécurité, entre Mysqli et PDO.",'2',0,'','2019-06-06 16:39:12','0000-00-00 00:00:00','non');
INSERT IGNORE INTO `sutache` (`idTache`, `nomTache`, `descriptionTache`, `idDemandeur`, `priorite`, `deadline`, `dateCreation`, `dateSuppr`, `suppr`) VALUES ('22',"Mail gros projets","Envoyer par mail le lien affichant les projets majeurs ainsi qu'une explication.",'2',0,'','2019-06-06 16:40:26','2019-06-11 16:12:29','non');
INSERT IGNORE INTO `sutache` (`idTache`, `nomTache`, `descriptionTache`, `idDemandeur`, `priorite`, `deadline`, `dateCreation`, `dateSuppr`, `suppr`) VALUES ('23',"Passage Mysqli","Passer l'application INFOFIN de Mysql à Mysqli et vérifier que tout fonctionne.",'2',0,'','2019-06-06 16:41:12','0000-00-00 00:00:00','non');
INSERT IGNORE INTO `sutache` (`idTache`, `nomTache`, `descriptionTache`, `idDemandeur`, `priorite`, `deadline`, `dateCreation`, `dateSuppr`, `suppr`) VALUES ('24',"Problème page profil INFOFIN","Régler le problème de la table p2_scientific_domain d'INFOFIN sur projetsdr.",'2',0,'','2019-06-06 16:42:13','0000-00-00 00:00:00','non');
INSERT IGNORE INTO `sutache` (`idTache`, `nomTache`, `descriptionTache`, `idDemandeur`, `priorite`, `deadline`, `dateCreation`, `dateSuppr`, `suppr`) VALUES ('25',"Ajout chercheurs+MA2 mailing","Ajouter tous les chercheurs et les masters2 au mailing.",'2',0,'','2019-06-06 16:48:26','0000-00-00 00:00:00','non');
INSERT IGNORE INTO `sutache` (`idTache`, `nomTache`, `descriptionTache`, `idDemandeur`, `priorite`, `deadline`, `dateCreation`, `dateSuppr`, `suppr`) VALUES ('26',"Bonnes pratiques encodage","Faire une sorte de manuel regroupant les bonnes pratiques d'encodage d'un INFOFIN",'2',0,'','2019-06-06 16:49:11','0000-00-00 00:00:00','non');
...
INSERT IGNORE INTO `sutache` (`idTache`, `nomTache`, `descriptionTache`, `idDemandeur`, `priorite`, `deadline`, `dateCreation`, `dateSuppr`, `suppr`) VALUES ('30',"Modification d'un projet","Régler le problème de modification d'un projet sur projetsdr/infofin.",'2',1,'0000-00-00 00:00:00','2019-06-11 11:11:56','0000-00-00 00:00:00','non');
...
INSERT IGNORE INTO `subd` (`idBD`, `nomBD`, `diminutif`, `color`) VALUES('bd4', "CVchercheurs", "CVC", '80002a'); 
INSERT IGNORE INTO `subd` (`idBD`, `nomBD`, `diminutif`, `color`) VALUES('bd5', "Port. Part.", "PoP", '66ffff'); 
INSERT IGNORE INTO `subd` (`idBD`, `nomBD`, `diminutif`, `color`) VALUES('bd6', "FU", "FU", '660066'); 
...
INSERT IGNORE INTO `sutuser` (`idUser`, `idTache`, `checked`, `adminC`) VALUES('3', '23', 0, 0); 
...
INSERT IGNORE INTO `sutuser` (`idUser`, `idTache`, `checked`, `adminC`) VALUES('3', '30', 0, 0); 
...
INSERT IGNORE INTO `suuser` (`idUser`, `nom`, `prenom`, `admin`,`login`,`password`, `dateDebut`, `dateFin`, `mail`, `color`) VALUES('5', "Vanobbergen", "Pierre", '0',"pv","", '2019-06-14 00:00:00', '0000-00-00 00:00:00', "pierrevob@hotmail.com", '00ff00'); 
ALTER TABLE `subd`
