...
<div>
    <table class='ta' style='border: none'>
        <tr>
            ...
            <td style='border: none'><a href="archive.php"><img src='img/Folder-Archive-icon.png' alt=''
                                                                title='Archiver'/>Archiver</a>&emsp;&emsp;<a
                        style='cursor: pointer' href='tacheArchi.php'><img src="img/Programming-Show-Property-icon.png"
                                                                           alt='Submit'
                                                                           title='Voir les tâches archivées'/>Tâches archivées</a></td>
        </tr>
    </table>
</div>
