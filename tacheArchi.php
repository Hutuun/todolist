...
if (empty($_SESSION["login"])){
    ...
    <table class='ta' style='border: none'>
        ...
        <?php echo "<td style='border: none'><form method='post' action='pdfarchi.php' id='sub$cpt'><input type='text' name='order' value='$order' hidden><input type='text' name='orderD' value='$orderD' hidden><a style='cursor: pointer' onclick='valider($cpt)'><img src='img/Download-icon.png' alt='Submit'>Version PDF des tâches archivées</a></form></td>"; ?>
    </table>
    <br/>
